...
const Register = () => {
    ...
    return (
        <>
        <Helmet>
                <title>GYMSTER || Register</title>
            </Helmet>
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co/THVdwL4/photo-1534438327276-14e5300c3a48.jpg)' }}>
                <div className="hero-overlay bg-opacity-90"></div>
                <div className="lg:ml-[600px] lg:mt-20">
                    <div className="">
                        <div className="px-10 py-4 border-4 rounded-md shadow-2xl">
                            <form onSubmit={handleSubmit(onSubmit)} className="font-medium">
                                ...
                                <div className="form-control">
                                    ...
                                    <input type="password" {...register("password", {
                                        ...
                                        minLength: 6,
                                        pattern: /(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z])/
                                    })} placeholder=" Enter Strong password" className="input input-bordered bg-transparent border-2 border-base-300" />
                            ...
                            <p className="text-center my-6 text-accent"> <span className="opacity-80 mr-2">Already have an account? Please</span> <Link to={'/login'} className="hover:text-lime-400 text-lg font-semibold">Login</Link></p>
                        </div>
                    </div>
                </div>
            </div>
